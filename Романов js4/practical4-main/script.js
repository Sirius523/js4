...
let getName2 = () => {return city1};
let exportStr2 = () => {return `name=${city1.name}\npopulation=${city1.population}\n`;}
let getCity = () => {return}
console.log(city1);
...
//function getCity1() { return getObj.apply(this).getName();}
//city1.getCity1 = getCity1;
//city2.getCity1 = getCity1;
//console.log(city1.exportStr());
//console.log(city2.exportStr());
//console.log(city1.getCity1());
//console.log(city2.getCity1());
